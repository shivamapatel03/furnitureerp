    ...
    <div className="max-w-2xl mx-auto space-y-4 sm:space-y-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-xs sm:text-sm text-gray-500">Add materials or items to inventory</p>
        </div>
      </div>
        ...
        <form action={createProduct} className="space-y-4 sm:space-y-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5 sm:gap-4">
            <div className="sm:col-span-2">
              <label htmlFor="name" className="block text-xs font-semibold text-gray-700 mb-1">Product / Material Name *</label>
              <input 
                type="text" 
                id="name" 
                name="name" 
            ...
            <div>
              <label htmlFor="purchasePrice" className="block text-xs font-semibold text-gray-700 mb-1">Purchase / Cost Price (₹)</label>
              <input 
                type="number" 
                step="any" 
                id="purchasePrice" 
            ...
            <div>
              <label htmlFor="stock" className="block text-xs font-semibold text-gray-700 mb-1">Initial Stock</label>
              <input 
                type="number" 
                step="any"
                id="stock" 
