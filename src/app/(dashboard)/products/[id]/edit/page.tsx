  ...
  return (
    <div className="max-w-2xl mx-auto space-y-4 sm:space-y-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-slate-100">Edit Product</h1>
          <p className="text-xs sm:text-sm text-gray-500 dark:text-slate-400">Update product details and stock</p>
        </div>
      </div>
        ...
        <form action={action} className="space-y-4 sm:space-y-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5 sm:gap-4">
            <div className="sm:col-span-2">
              <label htmlFor="name" className="block text-xs font-semibold text-gray-700 dark:text-slate-300 mb-1">Product Name *</label>
              <input 
                type="text" 
                id="name" 
                name="name" 
            ...
            <div>
              <label htmlFor="purchasePrice" className="block text-xs font-semibold text-gray-700 dark:text-slate-300 mb-1">Purchase Price (₹)</label>
              <input 
                type="number" 
                step="any" 
                id="purchasePrice" 
            ...
            <div>
              <label htmlFor="stock" className="block text-xs font-semibold text-gray-700 dark:text-slate-300 mb-1">Current Stock</label>
              <input 
                type="number" 
                step="any"
                id="stock" 
