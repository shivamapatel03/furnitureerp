  ...
  return (
    <div className="space-y-4 sm:space-y-6 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
        {/* Today's Sales */}
        <div className="bg-white p-3.5 sm:p-5 rounded-lg sm:rounded-xl border border-gray-200 shadow-xs flex flex-col justify-between">
          <div className="flex items-center justify-between mb-2">
            <span className="text-xs sm:text-sm text-gray-500 font-semibold truncate">Today's Sales</span>
            <div className="p-1.5 sm:p-2 bg-emerald-50 text-emerald-600 rounded-lg shrink-0">
              <IndianRupee className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
            </div>
          </div>
          <div>
            <p className="text-lg sm:text-2xl lg:text-3xl font-black text-gray-900 tracking-tight">
        ...
        <div className="bg-white p-3.5 sm:p-5 rounded-lg sm:rounded-xl border border-gray-200 shadow-xs flex flex-col justify-between">
          <div className="flex items-center justify-between mb-2">
            <span className="text-xs sm:text-sm text-gray-500 font-semibold truncate">This Month</span>
        ...
        <div className="bg-white p-3.5 sm:p-5 rounded-lg sm:rounded-xl border border-gray-200 shadow-xs flex flex-col justify-between">
          <div className="flex items-center justify-between mb-2">
            <span className="text-xs sm:text-sm text-gray-500 font-semibold truncate">Pending</span>
        ...
        <div className="bg-white p-3.5 sm:p-5 rounded-lg sm:rounded-xl border border-gray-200 shadow-xs flex flex-col justify-between">
          <div className="flex items-center justify-between mb-2">
            <span className="text-xs sm:text-sm text-gray-500 font-semibold truncate">Products</span>
